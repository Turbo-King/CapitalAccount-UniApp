...
var _default =
{
  ...
  methods: {
    //手机号登陆和找回密码点击事件
    clickChange: function clickChange(flag) {var _this = this;
      if (flag === 2) {
        this.forgetPasswordFlag = true;

        setTimeout(function () {
          _this.forgetPasswordFlag = false;
        }, 300);
      } else if (flag === 1) {
        this.telephoneLoginFlag = true;

        setTimeout(function () {
          _this.telephoneLoginFlag = false;
        }, 300);
        uni.login({
          provider: 'univerify',
    ...
    //登陆
    login: function login() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                //登陆按钮点击样式
